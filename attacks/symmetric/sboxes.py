# Shamelessly stolen from sage.crypto.sboxes
...
DryGASCON128 = [0x04, 0x0f, 0x1b, 0x01, 0x0b, 0x00, 0x17, 0x0d, 0x1f,
...
SYCON = [8, 19, 30, 7, 6, 25, 16, 13, 22, 15, 3, 24, 17, 12, 4, 27, 11, 0,
              29, 20, 1, 14, 23, 26, 28, 21, 9, 2, 31, 18, 10, 5]

# Bijective S-Boxes mapping 4 bits to 4
# =====================================

Elephant = [0xE, 0xD, 0xB, 0x0, 0x2, 0x1, 0x4, 0xF, 0x7, 0xA, 0x8, 0x5,
                 0x9, 0xC, 0x3, 0x6]
KNOT     = [0x4, 0x0, 0xA, 0x7, 0xB, 0xE, 0x1, 0xD, 0x9, 0xF, 0x6, 0x8,
                 0x5, 0x2, 0xC, 0x3]
Pyjamask_4 = [0x2, 0xd, 0x3, 0x9, 0x7, 0xb, 0xa, 0x6, 0xe, 0x0, 0xf, 0x4,
                   0x8, 0x5, 0x1, 0xc]
SATURNIN_0 = [0x0, 0x6, 0xE, 0x1, 0xF, 0x4, 0x7, 0xD, 0x9, 0x8, 0xC, 0x5,
                   0x2, 0xA, 0x3, 0xB]
SATURNIN_1 = [0x0, 0x9, 0xD, 0x2, 0xF, 0x1, 0xB, 0x7, 0x6, 0x4, 0x5, 0x3,
                   0x8, 0xC, 0xA, 0xE]
Spook = [0x0, 0x8, 0x1, 0xF, 0x2, 0xA, 0x7, 0x9, 0x4, 0xD, 0x5, 0x6, 0xE,
              0x3, 0xB, 0xC]
Clyde = Spook
Shadow = Spook
TRIFLE = [0x0, 0xC, 0x9, 0x7, 0x3, 0x5, 0xE, 0x4, 0x6, 0xB, 0xA, 0x2,
                 0xD, 0x1, 0x8, 0xF]
Yarara = [0x4, 0x7, 0x1, 0xC, 0x2, 0x8, 0xF, 0x3, 0xD, 0xA, 0xe, 0x9, 0xB,
                 0x6, 0x5, 0x0]
Coral = Yarara

# DES

DES_S1_1 = [14,4,13,1,2,15,11,8,3,10,6,12,5,9,0,7]
DES_S1_2 = [0,15,7,4,14,2,13,1,10,6,12,11,9,5,3,8]
DES_S1_3 = [4,1,14,8,13,6,2,11,15,12,9,7,3,10,5,0]
DES_S1_4 = [15,12,8,2,4,9,1,7,5,11,3,14,10,0,6,13]

DES_S2_1 = [15,1,8,14,6,11,3,4,9,7,2,13,12,0,5,10]
DES_S2_2 = [3,13,4,7,15,2,8,14,12,0,1,10,6,9,11,5]
DES_S2_3 = [0,14,7,11,10,4,13,1,5,8,12,6,9,3,2,15]
DES_S2_4 = [13,8,10,1,3,15,4,2,11,6,7,12,0,5,14,9]

DES_S3_1 = [10,0,9,14,6,3,15,5,1,13,12,7,11,4,2,8]
DES_S3_2 = [13,7,0,9,3,4,6,10,2,8,5,14,12,11,15,1]
DES_S3_3 = [13,6,4,9,8,15,3,0,11,1,2,12,5,10,14,7]
DES_S3_4 = [1,10,13,0,6,9,8,7,4,15,14,3,11,5,2,12]

DES_S4_1 = [7,13,14,3,0,6,9,10,1,2,8,5,11,12,4,15]
DES_S4_2 = [13,8,11,5,6,15,0,3,4,7,2,12,1,10,14,9]
DES_S4_3 = [10,6,9,0,12,11,7,13,15,1,3,14,5,2,8,4]
DES_S4_4 = [3,15,0,6,10,1,13,8,9,4,5,11,12,7,2,14]

DES_S5_1 = [2,12,4,1,7,10,11,6,8,5,3,15,13,0,14,9]
DES_S5_2 = [14,11,2,12,4,7,13,1,5,0,15,10,3,9,8,6]
DES_S5_3 = [4,2,1,11,10,13,7,8,15,9,12,5,6,3,0,14]
DES_S5_4 = [11,8,12,7,1,14,2,13,6,15,0,9,10,4,5,3]

DES_S6_1 = [12,1,10,15,9,2,6,8,0,13,3,4,14,7,5,11]
DES_S6_2 = [10,15,4,2,7,12,9,5,6,1,13,14,0,11,3,8]
DES_S6_3 = [9,14,15,5,2,8,12,3,7,0,4,10,1,13,11,6]
DES_S6_4 = [4,3,2,12,9,5,15,10,11,14,1,7,6,0,8,13]

DES_S7_1 = [4,11,2,14,15,0,8,13,3,12,9,7,5,10,6,1]
DES_S7_2 = [13,0,11,7,4,9,1,10,14,3,5,12,2,15,8,6]
DES_S7_3 = [1,4,11,13,12,3,7,14,10,15,6,8,0,5,9,2]
DES_S7_4 = [6,11,13,8,1,4,10,7,9,5,0,15,14,2,3,12]

DES_S8_1 = [13,2,8,4,6,15,11,1,10,9,3,14,5,0,12,7]
DES_S8_2 = [1,15,13,8,10,3,7,4,12,5,6,11,0,14,9,2]
DES_S8_3 = [7,11,4,1,9,12,14,2,0,6,10,13,15,3,5,8]
DES_S8_4 = [2,1,14,7,4,10,8,13,15,12,9,0,3,5,6,11]

# source: http://www.quadibloc.com/crypto/co0401.htm
Lucifer_S0 = [12,15,7,10,14,13,11,0,2,6,3,1,9,4,5,8]
Lucifer_S1 = [7,2,14,9,3,11,0,4,12,13,1,10,6,15,8,5]

# First GOST block cipher and its modification.
# ref: https://en.wikipedia.org/wiki/GOST_28147-89
GOST_1 = [0x4,0xa,0x9,0x2,0xd,0x8,0x0,0xe,0x6,0xb,0x1,0xc,0x7,0xf,0x5,0x3]
GOST_2 = [0xe,0xb,0x4,0xc,0x6,0xd,0xf,0xa,0x2,0x3,0x8,0x1,0x0,0x7,0x5,0x9]
GOST_3 = [0x5,0x8,0x1,0xd,0xa,0x3,0x4,0x2,0xe,0xf,0xc,0x7,0x6,0x0,0x9,0xb]
GOST_4 = [0x7,0xd,0xa,0x1,0x0,0x8,0x9,0xf,0xe,0x4,0x6,0xc,0xb,0x2,0x5,0x3]
GOST_5 = [0x6,0xc,0x7,0x1,0x5,0xf,0xd,0x8,0x4,0xa,0x9,0xe,0x0,0x3,0xb,0x2]
GOST_6 = [0x4,0xb,0xa,0x0,0x7,0x2,0x1,0xd,0x3,0x6,0x8,0x5,0x9,0xc,0xf,0xe]
GOST_7 = [0xd,0xb,0x4,0x1,0x3,0xf,0x5,0x9,0x0,0xa,0xe,0x7,0x6,0x8,0x2,0xc]
GOST_8 = [0x1,0xf,0xd,0x0,0x5,0x7,0xa,0x4,0x9,0x2,0x3,0xe,0x6,0xb,0x8,0xc]

# ref: https://eprint.iacr.org/2015/065.pdf
GOST2_1 = [0x6,0xA,0xF,0x4,0x3,0x8,0x5,0x0,0xD,0xE,0x7,0x1,0x2,0xB,0xC,0x9]
GOST2_2 = [0xE,0x0,0x8,0x1,0x7,0xA,0x5,0x6,0xD,0x2,0x4,0x9,0x3,0xF,0xC,0xB]

Magma_1 = [0xC,0x4,0x6,0x2,0xA,0x5,0xB,0x9,0xE,0x8,0xD,0x7,0x0,0x3,0xF,0x1]
Magma_2 = [0x6,0x8,0x2,0x3,0x9,0xA,0x5,0xC,0x1,0xE,0x4,0x7,0xB,0xD,0x0,0xF]
Magma_3 = [0xB,0x3,0x5,0x8,0x2,0xF,0xA,0xD,0xE,0x1,0x7,0x4,0xC,0x9,0x6,0x0]
Magma_4 = [0xC,0x8,0x2,0x1,0xD,0x4,0xF,0x6,0x7,0x0,0xA,0x5,0x3,0xE,0x9,0xB]
Magma_5 = [0x7,0xF,0x5,0xA,0x8,0x1,0x6,0xD,0x0,0x9,0x3,0xE,0xB,0x4,0x2,0xC]
Magma_6 = [0x5,0xD,0xF,0x6,0x9,0x2,0xC,0xA,0xB,0x7,0x8,0x1,0x4,0x3,0xE,0x0]
Magma_7 = [0x8,0xE,0x2,0x5,0x6,0x9,0x1,0xC,0xF,0x4,0xB,0x0,0xD,0xA,0x3,0x7]
Magma_8 = [0x1,0x7,0xE,0xD,0x0,0x5,0x8,0x3,0x4,0xF,0xA,0x6,0x9,0xC,0xB,0x2]

GOST_IETF_1 = [0x9,0x6,0x3,0x2,0x8,0xb,0x1,0x7,0xa,0x4,0xe,0xf,0xc,0x0,0xd,0x5]
GOST_IETF_2 = [0x3,0x7,0xe,0x9,0x8,0xa,0xf,0x0,0x5,0x2,0x6,0xc,0xb,0x4,0xd,0x1]
GOST_IETF_3 = [0xe,0x4,0x6,0x2,0xb,0x3,0xd,0x8,0xc,0xf,0x5,0xa,0x0,0x7,0x1,0x9]
GOST_IETF_4 = [0xe,0x7,0xa,0xc,0xd,0x1,0x3,0x9,0x0,0x2,0xb,0x4,0xf,0x8,0x5,0x6]
GOST_IETF_5 = [0xb,0x5,0x1,0x9,0x8,0xd,0xf,0x0,0xe,0x4,0x2,0x3,0xc,0x7,0xa,0x6]
GOST_IETF_6 = [0x3,0xa,0xd,0xc,0x1,0x2,0x0,0xb,0x7,0x5,0x9,0x4,0x8,0xf,0xe,0x6]
GOST_IETF_7 = [0x1,0xd,0x2,0x9,0x7,0xa,0x6,0x0,0x8,0xc,0x4,0x5,0xf,0x3,0xb,0xe]
GOST_IETF_8 = [0xb,0xa,0xf,0x5,0x0,0xc,0xe,0x8,0x6,0x2,0x3,0x9,0x1,0x7,0xd,0x4]

# Hummingbird-2
Hummingbird_2_S1 = [7,12,14,9,2,1,5,15,11,6,13,0,4,8,10,3]
Hummingbird_2_S2 = [4,10,1,6,8,15,7,12,3,0,14,13,5,9,11,2]
Hummingbird_2_S3 = [2,15,12,1,5,6,10,13,14,8,3,4,0,11,9,7]
Hummingbird_2_S4 = [15,4,5,8,9,7,2,1,10,3,0,14,6,12,13,11]
...
Fountain_1   = GIFT
TGIF         = GIFT
Fountain_2   = [0x9, 0x5, 0x6, 0xD, 0x8, 0xA, 0x7, 0x2, 0xE, 0x4, 0xC,
                     0x1, 0xF, 0x0, 0xB, 0x3]
Fountain_3   = [0x9, 0xD, 0xE, 0x5, 0x8, 0xA, 0xF, 0x2, 0x6, 0xC, 0x4,
                     0x1, 0x7, 0x0, 0xB, 0x3]
Fountain_4   = [0xB, 0xF, 0xE, 0x8, 0x7, 0xA, 0x2, 0xD, 0x9, 0x3, 0x4,
                     0xC, 0x5, 0x0, 0x6, 0x1]
...
Prost        = Pride
Qarma_sigma0 = [0, 14, 2, 10, 9, 15, 8, 11, 6, 4, 3, 7, 13, 12, 1, 5]
Qarma_sigma1 = [10, 13, 14, 6, 15, 7, 3, 5, 9, 8, 0, 12, 11, 1, 2, 4]
Qameleon     = Qarma_sigma1
Qarma_sigma2 = [11, 6, 8, 15, 12, 0, 9, 14, 3, 7, 4, 5, 13, 2, 1, 10]
REC_0        = [0x9,0x4,0xF,0xA,0xE,0x1,0x0,0x6,0xC,0x7,0x3,0x8,0x2,0xB,0x5,0xD]
Rectangle    = [0x6,0x5,0xC,0xA,0x1,0xE,0x7,0x9,0xB,0x0,0x3,0xD,0x8,0xF,0x4,0x2]
SC2000_4     = [2,5,10,12,7,15,1,11,13,6,0,9,4,8,3,14]
...
Luffa_v1 = [0x7,0xd,0xb,0xa,0xc,0x4,0x8,0x3,0x5,0xf,0x6,0x0,0x9,0x1,0x2,0xe]
Luffa = [0xd,0xe,0x0,0x1,0x5,0xa,0x7,0x6,0xb,0x3,0x9,0xc,0xf,0x8,0x2,0x4]
BLAKE_1 = [14,10,4,8,9,15,13,6,1,12,0,2,11,7,5,3]
BLAKE_2 = [11,8,12,0,5,2,15,13,10,14,3,6,7,1,9,4]
BLAKE_3 = [7,9,3,1,13,12,11,14,2,6,5,10,4,0,15,8]
BLAKE_4 = [9,0,5,7,2,4,10,15,14,1,11,12,6,8,3,13]
BLAKE_5 = [2,12,6,10,0,11,8,3,4,13,7,5,15,14,1,9]
BLAKE_6 = [12,5,1,15,14,13,4,10,0,7,6,3,9,2,8,11]
BLAKE_7 = [13,11,7,14,12,1,3,9,5,0,15,4,8,6,2,10]
BLAKE_8 = [6,15,14,9,11,3,0,8,12,2,13,7,1,4,10,5]
BLAKE_9 = [10,2,8,4,7,6,1,5,15,11,9,14,3,12,13,0]
JH_S0 = [9,0,4,11,13,12,3,15,1,10,2,6,7,5,8,14]
JH_S1 = [3,12,6,13,5,7,1,9,15,2,0,4,11,10,14,8]
SMASH_256_S1 = [6,13,12,7,15,1,3,10,8,11,5,0,2,4,14,9]
SMASH_256_S2 = [1,11,6,0,14,13,5,10,12,2,9,7,3,8,15,4]
SMASH_256_S3 = [4,2,9,12,8,1,14,7,15,5,0,11,6,10,3,13]

# Sub-components of larger S-Boxes
Anubis_S0 = [0xd,0x7,0x3,0x2,0x9,0xa,0xc,0x1,0xf,0x4,0x5,0xe,0x6,0x0,0xb,0x8]
Anubis_S1 = [0x4,0xa,0xf,0xc,0x0,0xd,0x9,0xb,0xe,0x6,0x1,0x7,0x3,0x5,0x8,0x2]
...
Enocoro_S4 = [1,3,9,10,5,14,7,2,13,0,12,15,4,8,6,11]
Iceberg_S0 = Anubis_S0
Iceberg_S1 = Anubis_S1
Khazad_P = [0x3,0xF,0xE,0x0,0x5,0x4,0xB,0xC,0xD,0xA,0x9,0x6,0x7,0x8,0x2,0x1]
Khazad_Q = [0x9,0xE,0x5,0x6,0xA,0x2,0x3,0xC,0xF,0x0,0x4,0xD,0x7,0xB,0x1,0x8]
Whirlpool_E = [0x1,0xB,0x9,0xC,0xD,0x6,0xF,0x3,0xE,0x8,0x7,0x4,0xA,0x2,0x5,0x0]
Whirlpool_R = [0x7,0xC,0xB,0xD,0xE,0x4,0x9,0xF,0x6,0x3,0x8,0xA,0x2,0x5,0x1,0x0]
CS_cipher_F = [0xf,0xd,0xb,0xb,0x7,0x5,0x7,0x7,0xe,0xd,0xa,0xb,0xe,0xd,0xe,0xf]
CS_cipher_G = [0xa,0x6,0x0,0x2,0xb,0xe,0x1,0x8,0xd,0x4,0x5,0x3,0xf,0xc,0x7,0x9]
Fox_S1 = [0x2,0x5,0x1,0x9,0xE,0xA,0xC,0x8,0x6,0x4,0x7,0xF,0xD,0xB,0x0,0x3]
Fox_S2 = [0xB,0x4,0x1,0xF,0x0,0x3,0xE,0xD,0xA,0x8,0x7,0x5,0xC,0x2,0x9,0x6]
Fox_S3 = [0xD,0xA,0xB,0x1,0x4,0x3,0x8,0x9,0x5,0x7,0x2,0xC,0xF,0x0,0x6,0xE]
Twofish_Q0_T0 = [0x8,0x1,0x7,0xD,0x6,0xF,0x3,0x2,0x0,0xB,0x5,0x9,0xE,0xC,0xA,0x4]
Twofish_Q0_T1 = [0xE,0xC,0xB,0x8,0x1,0x2,0x3,0x5,0xF,0x4,0xA,0x6,0x7,0x0,0x9,0xD]
Twofish_Q0_T2 = [0xB,0xA,0x5,0xE,0x6,0xD,0x9,0x0,0xC,0x8,0xF,0x3,0x2,0x4,0x7,0x1]
Twofish_Q0_T3 = [0xD,0x7,0xF,0x4,0x1,0x2,0x6,0xE,0x9,0xB,0x3,0x0,0x8,0x5,0xC,0xA]
Twofish_Q1_T0 = [0x2,0x8,0xB,0xD,0xF,0x7,0x6,0xE,0x3,0x1,0x9,0x4,0x0,0xA,0xC,0x5]
Twofish_Q1_T1 = [0x1,0xE,0x2,0xB,0x4,0xC,0x3,0x7,0x6,0xD,0xA,0x5,0xF,0x9,0x0,0x8]
Twofish_Q1_T2 = [0x4,0xC,0x7,0x5,0x1,0x6,0x9,0xA,0x0,0xE,0xD,0x8,0x2,0xB,0x3,0xF]
Twofish_Q1_T3 = [0xB,0x9,0x5,0x1,0xC,0x3,0xD,0xE,0x6,0x4,0x7,0xF,0x2,0x0,0x8,0xA]
Kuznyechik_nu0  = [0x2,0x5,0x3,0xb,0x6,0x9,0xe,0xa,0x0,0x4,0xf,0x1,0x8,0xd,0xc,0x7]
Kuznyechik_nu1  = [0x7,0x6,0xc,0x9,0x0,0xf,0x8,0x1,0x4,0x5,0xb,0xe,0xd,0x2,0x3,0xa]
Kuznyechik_sigma = [0xc,0xd,0x0,0x4,0x8,0xb,0xa,0xe,0x3,0x9,0x5,0x2,0xf,0x1,0x6,0x7]
Kuznyechik_phi   = [0xb,0x2,0xb,0x8,0xc,0x4,0x1,0xc,0x6,0x3,0x5,0x8,0xe,0x3,0x6,0xb]
...
Serpent_type_S0 = [0, 3, 5, 6, 7, 10, 11, 12, 13, 4, 14, 9, 8, 1, 2, 15]
Serpent_type_S1 = [0, 3, 5, 8, 6, 9, 10, 7, 11, 12, 14, 2, 1, 15, 13, 4]
Serpent_type_S2 = [0, 3, 5, 8, 6, 9, 11, 2, 13, 4, 14, 1, 10, 15, 7, 12]
Serpent_type_S3 = [0, 3, 5, 8, 6, 10, 15, 4, 14, 13, 9, 2, 1, 7, 12, 11]
Serpent_type_S4 = [0, 3, 5, 8, 6, 12, 11, 7, 9, 14, 10, 13, 15, 2, 1, 4]
Serpent_type_S5 = [0, 3, 5, 8, 6, 12, 11, 7, 10, 4, 9, 14, 15, 1, 2, 13]
Serpent_type_S6 = [0, 3, 5, 8, 6, 12, 11, 7, 10, 13, 9, 14, 15, 1, 2, 4]
Serpent_type_S7 = [0, 3, 5, 8, 6, 12, 11, 7, 13, 10, 14, 4, 1, 15, 2, 9]
Serpent_type_S8 = [0, 3, 5, 8, 6, 12, 15, 1, 10, 4, 9, 14, 13, 11, 2, 7]
Serpent_type_S9 = [0, 3, 5, 8, 6, 12, 15, 2, 14, 9, 11, 7, 13, 10, 4, 1]
Serpent_type_S10 = [0, 3, 5, 8, 6, 13, 15, 1, 9, 12, 2, 11, 10, 7, 4, 14]
Serpent_type_S11 = [0, 3, 5, 8, 6, 13, 15, 2, 7, 4, 14, 11, 10, 1, 9, 12]
Serpent_type_S12 = [0, 3, 5, 8, 6, 13, 15, 2, 12, 9, 10, 4, 11, 14, 1, 7]
Serpent_type_S13 = [0, 3, 5, 8, 6, 15, 10, 1, 7, 9, 14, 4, 11, 12, 13, 2]
Serpent_type_S14 = [0, 3, 5, 8, 7, 4, 9, 14, 15, 6, 2, 11, 10, 13, 12, 1]
Serpent_type_S15 = [0, 3, 5, 8, 7, 9, 11, 14, 10, 13, 15, 4, 12, 2, 6, 1]
Serpent_type_S16 = [0, 3, 5, 8, 9, 12, 14, 7, 10, 13, 15, 4, 6, 11, 1, 2]
Serpent_type_S17 = [0, 3, 5, 8, 10, 13, 9, 4, 15, 6, 2, 1, 12, 11, 7, 14]
Serpent_type_S18 = [0, 3, 5, 8, 11, 12, 6, 15, 14, 9, 2, 7, 4, 10, 13, 1]
Serpent_type_S19 = [0, 3, 5, 10, 7, 12, 11, 6, 13, 4, 2, 9, 14, 1, 8, 15]
Golden_S0 = [0, 3, 5, 8, 6, 9, 12, 7, 13, 10, 14, 4, 1, 15, 11, 2]
